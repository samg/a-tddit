...
class FoosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create foo" do
    assert_difference('Foo.count') do
      post foos_url, params: { foo: { foo1: @foo.foo1, foo2: @foo.foo2, foo3: @foo.foo3, foo4: @foo.foo4, foo5: @foo.foo5 } }
    end
  ...
  test "should update foo" do
    patch foo_url(@foo), params: { foo: { foo1: @foo.foo1, foo2: @foo.foo2, foo3: @foo.foo3, foo4: @foo.foo4, foo5: @foo.foo5 } }
