...
RSpec.describe "baz71s/edit", type: :view do
  before(:each) do
    @baz71 = assign(:baz71, Baz71.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz71 form" do
    render

    assert_select "form[action=?][method=?]", baz71_path(@baz71), "post" do
