...
RSpec.describe "bar42s/edit", type: :view do
  before(:each) do
    @bar42 = assign(:bar42, Bar42.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit bar42 form" do
    render

    assert_select "form[action=?][method=?]", bar42_path(@bar42), "post" do
