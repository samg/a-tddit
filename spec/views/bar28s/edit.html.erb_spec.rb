...
RSpec.describe "bar28s/edit", type: :view do
  before(:each) do
    @bar28 = assign(:bar28, Bar28.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit bar28 form" do
    render

    assert_select "form[action=?][method=?]", bar28_path(@bar28), "post" do
