...
RSpec.describe "bar71s/edit", type: :view do
  before(:each) do
    @bar71 = assign(:bar71, Bar71.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit bar71 form" do
    render

    assert_select "form[action=?][method=?]", bar71_path(@bar71), "post" do
