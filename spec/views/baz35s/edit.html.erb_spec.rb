...
RSpec.describe "baz35s/edit", type: :view do
  before(:each) do
    @baz35 = assign(:baz35, Baz35.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz35 form" do
    render

    assert_select "form[action=?][method=?]", baz35_path(@baz35), "post" do
