...
RSpec.describe "baz22s/edit", type: :view do
  before(:each) do
    @baz22 = assign(:baz22, Baz22.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz22 form" do
    render

    assert_select "form[action=?][method=?]", baz22_path(@baz22), "post" do
