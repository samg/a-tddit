...
RSpec.describe "baz9s/edit", type: :view do
  before(:each) do
    @baz9 = assign(:baz9, Baz9.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz9 form" do
    render

    assert_select "form[action=?][method=?]", baz9_path(@baz9), "post" do
