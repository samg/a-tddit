...
RSpec.describe "bar84s/edit", type: :view do
  before(:each) do
    @bar84 = assign(:bar84, Bar84.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit bar84 form" do
    render

    assert_select "form[action=?][method=?]", bar84_path(@bar84), "post" do
