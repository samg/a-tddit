...
RSpec.describe "baz66s/edit", type: :view do
  before(:each) do
    @baz66 = assign(:baz66, Baz66.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz66 form" do
    render

    assert_select "form[action=?][method=?]", baz66_path(@baz66), "post" do
