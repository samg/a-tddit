...
RSpec.describe "baz3s/edit", type: :view do
  before(:each) do
    @baz3 = assign(:baz3, Baz3.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz3 form" do
    render

    assert_select "form[action=?][method=?]", baz3_path(@baz3), "post" do
