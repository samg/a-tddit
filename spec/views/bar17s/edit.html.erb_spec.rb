...
RSpec.describe "bar17s/edit", type: :view do
  before(:each) do
    @bar17 = assign(:bar17, Bar17.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit bar17 form" do
    render

    assert_select "form[action=?][method=?]", bar17_path(@bar17), "post" do
