...
RSpec.describe "baz43s/edit", type: :view do
  before(:each) do
    @baz43 = assign(:baz43, Baz43.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz43 form" do
    render

    assert_select "form[action=?][method=?]", baz43_path(@baz43), "post" do
