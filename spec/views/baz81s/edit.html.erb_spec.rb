...
RSpec.describe "baz81s/edit", type: :view do
  before(:each) do
    @baz81 = assign(:baz81, Baz81.create!(
      foo1: "MyString",
      foo2: "9.99",
      foo3: 1,
      foo4: false,
  ...
  it "renders the edit baz81 form" do
    render

    assert_select "form[action=?][method=?]", baz81_path(@baz81), "post" do
